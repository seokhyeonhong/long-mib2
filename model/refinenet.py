...
class RefineNet(nn.Module):
    ...
    def forward(self, interp_motion, traj):
        ...
        # mask
        batch_mask = get_mask(interp_motion, self.config.context_frames)
        x = self.motion_encoder(torch.cat([interp_motion, batch_mask], dim=-1))
