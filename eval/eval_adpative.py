...
if __name__ == "__main__":
    ...
    transition = [ 60, 90, 120, 150, 180]
    adaptive = [50]
    # adaptive = [10, 20, 30, 40, 50]
    for adaptive_len in adaptive:
        print(f"===========================================Adaptive Length {adaptive_len}===========================================")
        for t in transition:
                ...
                for GT_motion in tqdm(dataloader):
                    ...
                    for b in range(B):
                        ...
                        while transition_start < T:
                            transition_end = min(transition_start + adaptive_len, T-1)
